...
class SocialProfilesWidgetPlus_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id( 'title' ); ?>" class="spwp-social-title"><?php echo __('Title:', 'spwp') ?></label>
		...
		<select autocomplete="off" id="<?php echo $this->get_field_id( 'version' ); ?>" class="widefat social-change-style" name="<?php echo $this->get_field_name( 'version' ); ?>">
			<option value="regular" <?php if($instance_social_version == 'regular'){ echo 'selected="selected"'; } ?>><?php echo __('Regular Icons', 'spwp'); ?></option>
			<option value="flat" <?php if($instance_social_version == 'flat'){ echo 'selected="selected"'; } ?>><?php echo __('Flat Icons', 'spwp'); ?></option>
		</select>
		...
		<div class="spwp-social-single dummy">
			...
			<select autocomplete="off" data-id="<?php echo $this->get_field_id( 'social-id' ); ?>" class="spwp-profile-name" data-name="<?php echo $this->get_field_name( 'social-id' ); ?>[]">
				<option value="empty"><?php echo __('&lt;select icon&gt;', 'spwp'); ?></option>
				<?php foreach ($this->icons_list as $profile_id => $profile_value) {
					echo '<option value="'.$profile_id.'">'.$profile_value.'</option>'."\n";
				} ?>
			</select>
			<input data-id="<?php echo $this->get_field_id( 'social-url' ); ?>" class="spwp-profile-link" type="text" placeholder="<?php echo __('Profile link...', 'spwp'); ?>" data-name="<?php echo $this->get_field_name( 'social-url' ); ?>[]">
		...
		<div class="spwp-social-sortable <?php if($instance_social_version == 'flat'){ echo 'flat'; } ?>">
				...
				<?php foreach ( $instance_social_id as $id){ ?>
					...
					<div class="spwp-social-single">
						...
						<select autocomplete="off" id="<?php echo $this->get_field_id( 'social-id' ); ?>" class="spwp-profile-name" name="<?php echo $this->get_field_name( 'social-id' ); ?>[]">
							<option <?php if ( $id == 'none' ) echo 'selected="selected"'; ?> value="empty"><?php echo __('&lt;select icon&gt;', 'spwp'); ?></option>
							<?php foreach ($this->icons_list as $profile_id => $profile_value) {
						...
						<?php if ($id != 'skype' && $id != 'email'){ ?>
							<input id="<?php echo $this->get_field_id( 'social-url' ); ?>" class="spwp-profile-link" type="text" placeholder="<?php echo __('Profile link...', 'spwp'); ?>" value="<?php echo $instance_social_url[$i]; ?>" name="<?php echo $this->get_field_name( 'social-url' ); ?>[]">
						<?php } else if ($id == 'email') { ?>
							<input id="<?php echo $this->get_field_id( 'social-url' ); ?>" class="spwp-profile-link" type="text" placeholder="<?php echo __('Email address or contact page link...', 'spwp'); ?>" value="<?php echo $instance_social_url[$i]; ?>" name="<?php echo $this->get_field_name( 'social-url' ); ?>[]">
						<?php } else if ($id == 'skype') { ?>
							<input id="<?php echo $this->get_field_id( 'social-url' ); ?>" class="spwp-profile-link" type="text" placeholder="<?php echo __('Skype username...', 'spwp'); ?>" value="<?php echo $instance_social_url[$i]; ?>" name="<?php echo $this->get_field_name( 'social-url' ); ?>[]">
						<?php } ?>
						<a href="" class="spwp-social-remove">x</a>
					</div>
			...
			<?php } else { ?>
				...
				<div class="spwp-social-single">
					...
					<input id="<?php echo $this->get_field_id( 'social-url' ); ?>" class="spwp-profile-link" type="text" placeholder="<?php echo __('Profile link...', 'spwp'); ?>" value="<?php echo $instance_social_url; ?>" name="<?php echo $this->get_field_name( 'social-url' ); ?>[]">
					<a href="" class="spwp-social-remove">x</a>
				</div>
		...
		<a href="" class="spwp-social-new">+ <?php echo __('Add another', 'spwp'); ?></a>
